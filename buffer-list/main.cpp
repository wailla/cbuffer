...
//    assert(other.extract()==2);
    ...
    std::cout << other.get_head()<<std::endl;*/
    other.clear();
    std::cout<<"elementi nella lista dopo clear(): "<<other.elementiIn()<<std::endl;
    //std::cout << other.get_head()<<std::endl;
...
int main() {
    /*fondamentalTest();
    useCbufferlistInt();*/
    cbufferlist<int, equalInt> buff1(5);
